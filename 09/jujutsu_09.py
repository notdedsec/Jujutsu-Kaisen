...
from kaisen_common.sources import E09 as SRC
...
NO_DENOISE_RANGES = [(9443, 9467), (10121, 10346), (28433, 28631)]

LETTERBOX_RANGES = {
    (5244, 5280): dict(height=156)
}

ZONES = {
    (9443, 9467): dict(b=0.85),
    (10121, 10346): dict(b=0.85),
    (28433, 28631): dict(b=0.85)
}
