...
from kaisen_common.sources import E10 as SRC
...
NO_DENOISE_RANGES = [(22036, 22429), (22594, 22722)]

MASKS = {
    (13765, 14329): blank_mask(SRC.clip_cut)
}

ZONES = {
    (22036, 22429): dict(b=0.85),
    (22594, 22722): dict(b=0.85)
}
